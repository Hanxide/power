...
public class SystemUtils {
    ...
    public static boolean isTheStyle(String pStr, String pStyle) {
        for (int i = 0; i < pStr.length(); i++) {
            ...
            if (pStyle.equals(SysConstants.S_STYLE_N)) {
                if (!Character.isDigit(c))
                    return false;
            } else if (pStyle.equals(SysConstants.S_STYLE_L)) {
                if (!Character.isLetter(c))
                    return false;
            } else if (pStyle.equals(SysConstants.S_STYLE_NL)) {
    ...
    public static String[] getMonth(int offset) {
        ...
        String result[] = new String[2];
        Calendar calendar = Calendar.getInstance();
        calendar.add(Calendar.MONTH, 1 + offset);
        result[1] = sdf.format(calendar.getTime());
    ...
    public static String getWeekDayByDate(String strdate) {
        final String dayNames[] = {I18nSupport.getString("global.week.sun"), I18nSupport.getString("global.week.mon"), I18nSupport.getString("global.week.tue"),
                I18nSupport.getString("global.week.wed"), I18nSupport.getString("global.week.thu"), I18nSupport.getString("global.week.fri"), I18nSupport.getString("global.week.sat")};
    ...
    public static List<Dto> removeDuplicateObj(List<Dto> list) {
        ...
        for (Dto dto : list) {
            if (set.add(dto.getAsString("code")))
                results.add(dto);
        }
        return results;
    }
